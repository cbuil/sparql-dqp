...
import es.upm.fi.dia.oeg.ogsadai.sparql.client.config.Query;
import es.upm.fi.dia.oeg.ogsadai.sparql.client.config.QueryLoader;
...
public class QueryTest
{
    ...
    private static void runWorkflow(String query, String url)
            ...
            IOException, UnsupportedTupleTypeException, SQLException
    {
        ...
        jerseyServer.setDefaultBaseServicesURL(new URL(url));
