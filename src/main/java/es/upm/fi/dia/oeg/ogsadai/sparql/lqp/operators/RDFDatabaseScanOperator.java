...
public class RDFDatabaseScanOperator extends UnaryOperator implements
        ScanOperator
{
    ...
    private static final DAILogger LOG = DAILogger
            .getLogger(RDFDatabaseScanOperator.class);
     ...
     * @param bgp 
     */
    public RDFDatabaseScanOperator(String query, String source,
            List<String> varList, List<String> valuesList, SimpleBasicGraphPattern bgp)
    {
        this.mID = OperatorID.getInstance("RDF_DATABASE_SCAN");
