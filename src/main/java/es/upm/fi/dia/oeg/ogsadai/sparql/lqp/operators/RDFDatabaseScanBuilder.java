...
public class RDFDatabaseScanBuilder implements ActivityPipelineBuilder
{
    /** Copyright statement. */
    ...
    {
        RDFDatabaseScanOperator operator = (RDFDatabaseScanOperator) op;

        GenericActivity query = new GenericActivity(
                "es.upm.fi.dia.oeg.RDFDBQueryActivity");
...
//        return query.getOutput("rdfdata");
    }
}
