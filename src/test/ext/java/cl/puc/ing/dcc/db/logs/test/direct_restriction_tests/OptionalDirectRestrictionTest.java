...
public class OptionalDirectRestrictionTest extends TestCase
{
    /** Copyright statement. */
     ...
     */
    public OptionalDirectRestrictionTest(String name) throws Exception
    {
        super(name);
    }
    ...
    public void setUp() throws Exception
    {
        ...
        mTestQueries.put("testProcessWhereOptional1",
                "PREFIX :  <http://example.org/ns#> "
                        + "PREFIX a: <http://example.org/ns2#> "
                        + "SELECT * WHERE { ?a :b ?c . ?a :f ?g }");
        mTestQueries.put("testProcessWhereOptional2",
                "PREFIX :  <http://example.org/ns#> "
                        + "PREFIX a: <http://example.org/ns2#> "
                        + "SELECT * WHERE { ?a :b ?c . ?a ?f ?g  OPTIONAL { ?a :f ?g }}");
        ...
        String query1 = mTestQueries.get("testProcessWhereOptional1");
        String query2 = mTestQueries.get("testProcessWhereOptional2");
