...
public class FilterDirectRestrictionTest extends TestCase
{
    /** Copyright statement. */
     ...
     */
    public FilterDirectRestrictionTest(String name) throws Exception
    {
        super(name);
    }
    ...
    public void setUp() throws Exception
    {
        ...
        mTestQueries
                .put("testProcessWhereFilter1",
                        "PREFIX :  <http://example.org/ns#> "
                                + "PREFIX a: <http://example.org/ns2#> "
                                + "SELECT * WHERE { ?a ?b ?c FILTER regex(?a, \"test\")}");
        ...
        String query1 = mTestQueries.get("testProcessWhereFilter1");
        String query2 = mTestQueries.get("testProcessWhereFilter2");
