...
public class AndRestrictionRuleTest extends TestCase
{
    /** Copyright statement. */
     ...
     */
    public AndRestrictionRuleTest(String name) throws Exception
    {
        super(name);
    }
    ...
    public void setUp() throws Exception
    {
        ...
        mTestQueries.put("testProcessWhereAnd1",
                "PREFIX :  <http://example.org/ns#> "
                        + "PREFIX a: <http://example.org/ns2#> "
                        + "SELECT * WHERE { ?a :b ?c . ?a ?f ?g . ?a :f ?g }");
        mTestQueries.put("testProcessWhereAnd2",
                "PREFIX :  <http://example.org/ns#> "
                        + "PREFIX a: <http://example.org/ns2#> "
        ...
        String query1 = mTestQueries.get("testProcessWhereAnd1");
        String query2 = mTestQueries.get("testProcessWhereAnd2");
...
//    {
//        Map<Integer, List<Operator>> opMap = new HashMap<>();
//        int depth = 0;
//
//        PatternRestrictor pr = new PatternRestrictor();
//        pr.getPatternLevels(mLqpRoot1, opMap, depth);
//
//        assertNull(opMap);
//
//    }
