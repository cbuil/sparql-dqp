...
public class TriplePatternDirectRestrictionTest extends TestCase
{
    /** Copyright statement. */
     ...
     */
    public TriplePatternDirectRestrictionTest(String name) throws Exception
    {
        super(name);
    }
    ...
    public void setUp() throws Exception
    {
        ...
        mTestQueries.put("testProcessWheretriplePattern1",
                "PREFIX :  <http://example.org/ns#> "
                        + "PREFIX a: <http://example.org/ns2#> "
                        + "SELECT * WHERE { ?a :b ?c}");
        mTestQueries.put("testProcessWheretriplePattern2",
                "PREFIX :  <http://example.org/ns#> "
                        + "PREFIX a: <http://example.org/ns2#> "
                        + "SELECT * WHERE { ?a ?b ?c}");
        ...
        String query1 = mTestQueries.get("testProcessWheretriplePattern1");
        String query2 = mTestQueries.get("testProcessWheretriplePattern2");
